...
@ConditionalOnMissingClass(value = "com.mycompany.myapp.web.rest.ProductResourceExtend")
public class ProductResource {

    protected static final Logger log = LoggerFactory.getLogger(ProductResource.class);
