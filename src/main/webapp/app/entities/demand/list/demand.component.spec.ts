...
import { sampleWithRequiredData } from '../demand.test-samples';
...
describe('Demand Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.demands?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to demandService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDemandIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDemandIdentifier).toHaveBeenCalledWith(entity);
